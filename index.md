...
Day2: Using protective gloves, add phenol crystals to lactic acid in a glass beaker and stir using a magnetic stirrer until the crystals dissolve.
Add glycerol
Filter the Cotton blue and the distilled water into the phenol + glycerol +lactic acid solution and mix.
